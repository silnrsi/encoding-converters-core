...
namespace SilEncConverters40
{
    ...
    public class SelectConverter : System.Windows.Forms.Form
    {
		...
		private ToolStripMenuItem menuItemTest;
            ...
            string strChooseConverterDialogTitle, byte[] abyPreviewData, string strFontName)
        {
            ...
            Util.DebugWriteLine(this, "(1) FINISHED");
        }
            ...
            string strChooseConverterDialogTitle, string strPreviewData, string strFontName)
        {
            ...
            textBoxDataPreview.Hide();
            tableLayoutPanel1.RowCount = 4;
            Util.DebugWriteLine(this, "(2) FINISHED");
        }
        ...
        public IEncConverter IEncConverter
        {
            get
            {
                ...
                if (!String.IsNullOrEmpty(m_strConverterName))
                {
                    ...
                    //  run-time properties below (which works on Windows). So it's being made conditional on Mono here so I don't
    ...
    "e:";
        ...
        "ms)");
            ...
            this.menuItemTest.Size = new System.Drawing.Size(180, 22);
            ...
            this.listBoxExistingConverters.Size = new System.Drawing.Size(542, 198);
            ...
            this.contextMenuStripPreview.Size = new System.Drawing.Size(211, 110);
            // 
            ...
            this.menuItemRefresh.Text = "&Refresh List";
        ...
        {
            Util.DebugWriteLine(typeof(SelectConverter).Name, "BEGIN");
            try
            {
