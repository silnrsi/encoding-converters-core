...
namespace TestEncCnvtrs
{
    ...
    public class TestPyScriptEncConverters
    {
        ...
        public void TestPyScriptEncConvertersAll()
        {
            ...
            m_encConverters.AddConversionMap(convnames[n], Path.Combine(dir, filenames[n]),
                ConvType.Legacy_to_from_Unicode, EncConverters.strTypeSILPyScript,
            ...
            m_encConverters.AddConversionMap(convnames[n], Path.Combine(dir, filenames[n]),
                ConvType.Unicode_to_from_Legacy, EncConverters.strTypeSILPyScript,
            ...
            m_encConverters.AddConversionMap(convnames[n], Path.Combine(dir, filenames[n]),
                ConvType.Unicode_to_from_Unicode, EncConverters.strTypeSILPyScript,
            ...
            m_encConverters.AddConversionMap(convnames[n], Path.Combine(dir, filenames[n]),
                ConvType.Legacy_to_from_Legacy, EncConverters.strTypeSILPyScript,
