...
")]
		...
		[TestCase(@"{^\\v ([\d-]+) }->{$1:\r\n};2", "\\v 4 अपर सरपैं ग्‍लाया, “तुसां बिलकुल नी मरना ह़ै,", @"4:
अपर सरपैं ग्‍लाया, “तुसां बिलकुल नी मरना ह़ै,")]
		[TestCase(@"{^\\v ([\d-]+) }->{$1:\u000d\u000a};2", "\\v 4 अपर सरपैं ग्‍लाया, “तुसां बिलकुल नी मरना ह़ै,", "4:\r\nअपर सरपैं ग्‍लाया, “तुसां बिलकुल नी मरना ह़ै,")]
		[TestCase(@"{\\qt[12]-s \|(.*?)(?:\\)+\* ?}->{};2", "\\v 1 \\qt1-s |narrator-GEN\\* परमेसरैं सरिस्‍टिआ दी रचना इंह़आं कित्ती: ", "\\v 1 परमेसरैं सरिस्‍टिआ दी रचना इंह़आं कित्ती: ")]
		[TestCase(@"{\\qt[12]-s \|(.*?)(?:\\)+\* ?}->{$1 };2", "\\v 1 \\qt1-s |narrator-GEN\\* परमेसरैं सरिस्‍टिआ दी रचना इंह़आं कित्ती: ", "\\v 1 narrator-GEN परमेसरैं सरिस्‍टिआ दी रचना इंह़आं कित्ती: ")]
		[TestCase(@"{\\qt[12]-s \|(.*?)(?:\\)+\* ?}->{\r\nspkrEmb: $1\r\n};0", "\\v 1 \\qt1-s |Moses\\* परमेसरैं सरिस्‍टिआ दी रचना इंह़आं कित्ती: ", @"\v 1 
spkrEmb: Moses
परमेसरैं सरिस्‍टिआ दी रचना इंह़आं कित्ती: ")]
