...
namespace SilEncConverters40.EcTranslators.GoogleTranslator
{
	partial class GoogleTranslatorAutoConfigDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.tableLayoutPanel1.Controls.Add(this.buttonSetGoogleTranslateApiKey, 1, 6);
			...
			this.buttonSetGoogleTranslateApiKey.Name = "buttonSetBingTranslateApiKey";
			this.buttonSetGoogleTranslateApiKey.Size = new System.Drawing.Size(214, 23);
			this.buttonSetGoogleTranslateApiKey.TabIndex = 14;
			this.buttonSetGoogleTranslateApiKey.Text = "Enter your own Azure Translate Api Key";
